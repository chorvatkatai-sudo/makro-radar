window.MAKRO_DATA = {
 ...
 "briefing": {
  ...
  "tagesnews": {
   ...
   "tenor": "Das große Inflations-Event ist da — und es war ein Schuss in die Luft: Der US-PCE kam genau wie erwartet (Jahresrate firm bei 2,9%), aber der Monatswert war einen Tick KÜHLER. Heißt: Kein neues Feuer für die aggressivsten Zins-Wetten, der Dollar bleibt zwar stark, aber die heiße Phase ist erst mal abgebremst. Gleichzeitig zeigt der australische Arbeitsmarkt Muskeln — der Aussie ist heute der heimliche Gewinner.",
   "heute": [
    "🇺🇸 DAS Event ist durch — der US-PCE (Lieblings-Inflationswert der Fed, Mai): Der Kern-PCE liegt bei 2,9% im Jahr — GENAU wie erwartet, aber der höchste Stand seit September 2025 (also weiter zäh). Der entscheidende Monatswert kam mit nur +0,2% rein — einen Tick KÜHLER als die erwarteten +0,3% und runter von +0,4% im April. Übersetzung: Die Inflation ist noch klebrig, aber sie heizt sich nicht weiter auf. Für die Dollar-Bullen, die auf eine richtig heiße Zahl gehofft hatten, ist das eine kleine Enttäuschung — es nimmt etwas Druck aus den Wetten auf eine Fed-Erhöhung schon im September.",
    "🤔 Spannend: Die Fed selbst hat ihre PCE-Prognose fürs Jahresende erst letzte Woche auf 3,6% hochgeschraubt — die echte Zahl steht aber bei 2,9%. Die Realität ist also (noch) ruhiger als die Angst der Fed. Solange die Daten so bleiben, ist die ganz harte Erhöhungs-Story nicht hieb- und stichfest.",
    "🇦🇺 Heimspiel für den Aussie: Australiens Arbeitsmarkt (Mai) kam STARK rein — die Arbeitslosenquote fiel auf 4,4% (von 4,5%), mehr Menschen in Arbeit. Zusammen mit dem heißen Kern-Inflationswert von gestern (3,6%) heißt das: Die RBA bleibt hart, kann nicht so schnell senken. Der AUD ist heute der relative Gewinner und wehrt sich gegen den starken Dollar. (Kleiner Wermutstropfen: die geleisteten Arbeitsstunden fielen — unter der Oberfläche ist es nicht ganz so rosig.)",
    "🇺🇸 Nebenwerte heute: das finale US-BIP fürs 1. Quartal und die wöchentlichen Arbeitslosen-Erstanträge — eher Begleitmusik zum PCE, selten ein großer Auslöser."
   ],
   "gestern": [
  ...
  "waehrungen": {
   "USD": {
    "stimmung": "bullisch",
    "score": 38,
    "grund": "Dollar bleibt stark (Index ~101,6, 13-Monats-Hoch) — aber der PCE am Donnerstag hat die Falken-Story nur halb bestätigt: Jahresrate firm bei 2,9% (zäh), Monatswert aber mit +0,2% einen Tick KÜHLER als erwartet. Das nimmt etwas Wind aus den aggressivsten Wetten auf eine September-Erhöhung. Dollar weiter oben, aber die Spitze ist erst mal gedeckelt — deshalb Score leicht zurück."
   },
   "EUR": {
    "stimmung": "bärisch",
    "score": -25,
   ...
   "AUD": {
    "stimmung": "neutral",
    "score": 2,
    "grund": "Heimliche Stärke: Der Arbeitsmarkt kam stark rein (Arbeitslosenquote fiel auf 4,4%), dazu der heiße Kern-Inflationswert (Trimmed Mean 3,6%, höchster seit Sept 2024). Beides hält die RBA hart und stützt den Aussie — heute der relative Gewinner unter den Majors. Mit dem leicht abgebremsten Dollar reicht es jetzt für neutral (vorher leicht bärisch)."
   },
   "NZD": {
    "stimmung": "bärisch",
    "score": -25,
  ...
  "paare": [
   {
    "paar": "USD/CAD",
    "score": 27,
    "treiber": "Weiter aufwärts: starker Dollar TRIFFT auf billiges Öl (~80$ nach Iran-Deal) und einen Loonie, dem die heiße Schlagzeilen-Inflation kaum half (Kern am Ziel, BOC schaut drüber hinweg). Mit dem leicht abgebremsten Dollar Score etwas zurück."
   },
   {
    "paar": "USD/CHF",
    "score": 20,
    "treiber": "Dollar oben, während der Franken null Zins hat und seine Krisen-Prämie mit dem Iran-Deal verliert. Paar weiter aufwärts geneigt — nach dem nur halb heißen PCE etwas gedeckelt."
   },
   {
    "paar": "EUR/USD",
    "score": -23,
    "treiber": "Zinsabstand USA–Europa weit offen, Europa-PMIs schwach (Eurozone 49,5). EUR/USD Richtung 1,136 gefallen. Bärisch — aber der kühlere PCE-Monatswert gibt dem Euro einen kleinen Atemzug, daher Score etwas weniger negativ."
   },
   {
    "paar": "NZD/USD",
    "score": -22,
    "treiber": "Schwache Story: niedriger NZ-Zins, BIP q/q verfehlt, voller Dollar-Druck. Kiwi mit wenig Gegenwehr — leichte Entlastung nur durch den etwas abgebremsten Dollar."
   },
   {
    "paar": "GBP/USD",
    "score": -20,
    "treiber": "Pfund gemischt (Schlagzeile kühl, Dienstleistungen heiß), gegen den starken Dollar überwiegt die Schwäche. Stagflations-Schatten bleibt. (Track-Record dieses Paars bisher gut, aber Stichprobe noch dünn.)"
   },
   {
    "paar": "USD/JPY",
    "score": 10,
    "treiber": "Trend bullish (starker Dollar), ABER bei ~161,8 wächst das INTERVENTIONSRISIKO: Japans Finanzministerium warnt offen, „jederzeit bereit\" zu sein. Eine Intervention kann das Paar in Minuten brutal nach unten reißen — Score gedeckelt, durch den kühleren PCE zusätzlich etwas zurück."
   },
   {
    "paar": "AUD/USD",
    "score": -2,
    "treiber": "Fast neutral: starker Arbeitsmarkt (Quote 4,4%) + heißer Kern (Trimmed Mean 3,6%) halten die RBA hart und machen den Aussie zum relativen Gewinner. Der nur halb heiße US-PCE bremst den Dollar zusätzlich. Track-Record dieses Paars noch dünn — daher kein bullisher Kipp, nur nahe null."
   }
  ],
  "wochenausblick": {
   "text": [
